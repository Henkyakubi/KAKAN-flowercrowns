...
public class CrownOfOxeyeDaisyHelmetTickEventProcedure extends KakanModElements.ModElement {
	public CrownOfOxeyeDaisyHelmetTickEventProcedure(KakanModElements instance) {
		super(instance, 37);
	}
