...
public class CrownOfAlliumHelmetTickEventProcedure extends KakanModElements.ModElement {
	public CrownOfAlliumHelmetTickEventProcedure(KakanModElements instance) {
		super(instance, 14);
	}
