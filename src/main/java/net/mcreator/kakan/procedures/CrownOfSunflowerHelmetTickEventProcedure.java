...
public class CrownOfSunflowerHelmetTickEventProcedure extends KakanModElements.ModElement {
	public CrownOfSunflowerHelmetTickEventProcedure(KakanModElements instance) {
		super(instance, 68);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				System.err.println("Failed to load dependency entity for procedure CrownOfSunflowerHelmetTickEvent!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				System.err.println("Failed to load dependency world for procedure CrownOfSunflowerHelmetTickEvent!");
			return;
		}
