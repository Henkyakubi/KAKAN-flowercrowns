...
import net.mcreator.kakan.procedures.CrownOfAlliumHelmetTickEventProcedure;
...
public class CrownOfAlliumItem extends KakanModElements.ModElement {
	@ObjectHolder("kakan:crown_of_allium_helmet")
	public static final Item helmet = null;
	@ObjectHolder("kakan:crown_of_allium_chestplate")
	public static final Item body = null;
	@ObjectHolder("kakan:crown_of_allium_leggings")
	public static final Item legs = null;
	@ObjectHolder("kakan:crown_of_allium_boots")
	public static final Item boots = null;
	public CrownOfAlliumItem(KakanModElements instance) {
		super(instance, 12);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(KAKANItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "kakan:textures/models/armor/crown_of_allium-v2__layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
